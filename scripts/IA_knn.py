...
def eval_knn():
    ...
    prediction = useknn.predict_class_knn(config2[:])
    return(prediction)
...
def create_tree_B(): #arbre non-lisible mais seulement utile pour alpha_beta et min-max
    """
        ...
        * Each one is associated with an evaluation of the final chessboard configuration, evaluated thanks to knn model
