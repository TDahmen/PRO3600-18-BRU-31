...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        # clé = bouton de l'interface graphique ; valeur = position sur l'échiquier du moteur de jeu echecs.py
        ...
        # Création du dictionnaire (correspondance avec le tableau du moteur de jeu)
        # C'est le dictionnaire "inverse" du précédent (dict1)
        # clé = position sur l'échiquier du moteur de jeu echecs.py ; valeur = bouton de l'interface graphique
        ...
        # On doit les connecter à une fonction, mais on veut passer en argument le sender
        # Donc on utilise une fonction anonyme (qui renvoie le résultat de chk(pièce) )
